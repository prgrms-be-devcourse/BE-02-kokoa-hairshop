...
public class HairshopConverter {
    ...
    public Hairshop convertToHairshop(CreateHairshopRequest createHairshopRequest, User user) {
    ...
    public Hairshop convertToHairshop(ModifyHairshopRequest modifyHairshopRequest, User user) {
        return Hairshop.builder()
