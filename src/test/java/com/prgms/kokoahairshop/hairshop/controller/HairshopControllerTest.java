...
class HairshopControllerTest {
    ...
    void setup() {
        ...
        createHairshopRequest = CreateHairshopRequest.builder()
                ...
                .userId(user.getId())
                .build();
        hairshop = hairshopConverter.convertToHairshop(createHairshopRequest, user);
                ...
                .andDo(
                        document("register-hairshop",
                                requestFields(
                                        ...
                                        fieldWithPath("closedDay").type(JsonFieldType.STRING)
                                                .description("closedDay"),
                                        fieldWithPath("reservationRange").type(JsonFieldType.STRING)
                                                .description("reservationRange"),
                                        ...
                                        fieldWithPath("sameDayAvailable").type(JsonFieldType.BOOLEAN)
                                                .description("sameDayAvailable"),
                                        fieldWithPath("roadNameNumber").type(JsonFieldType.STRING)
                                                .description("roadNameNumber"),
                ...
                .andDo(document("getAll-hairshop",
                        responseFields(
                                ...
                                fieldWithPath("content[].endTime").type(JsonFieldType.STRING)
                                        .description("endTime"),
                                fieldWithPath("content[].closedDay").type(JsonFieldType.STRING)
                                        .description("closedDay"),
                                fieldWithPath("content[].reservationRange").type(JsonFieldType.STRING)
                                        .description("reservationRange"),
                                fieldWithPath("content[].reservationStartTime").type(JsonFieldType.STRING)
                                        .description("reservationStartTime"),
                                fieldWithPath("content[].reservationEndTime").type(JsonFieldType.STRING)
                                        .description("reservationEndTime"),
                                fieldWithPath("content[].sameDayAvailable").type(JsonFieldType.BOOLEAN)
                                        .description("sameDayAvailable"),
                                fieldWithPath("content[].roadNameNumber").type(JsonFieldType.STRING)
                                        .description("roadNameNumber"),
                                fieldWithPath("content[].profileImg").type(JsonFieldType.STRING)
                                        .description("profileImg"),
