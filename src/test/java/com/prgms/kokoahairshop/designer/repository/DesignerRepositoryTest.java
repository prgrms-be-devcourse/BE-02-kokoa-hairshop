...
class DesignerRepositoryTest {
    ...
    void findDesignerFetchJoinByHairshopIdAndDateTest() {
        ...
        assertThat(designers.get(0).getReservationTimes().get(0).getId()).isEqualTo(reservationTime1.getId());
        assertThat(designers.get(0).getReservationTimes().get(1).getId()).isEqualTo(reservationTime2.getId());
    }
}
