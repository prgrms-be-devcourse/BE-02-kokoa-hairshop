            ...
            .andDo(
                document("register-menu",
                    requestFields(
                        ...
                        fieldWithPath("exposedTime").type(JsonFieldType.NUMBER)
                            .description("exposedTime"),
        ...
        this.mockMvc.perform(get("/menu")
            ...
            .andDo(document("getAll-menu",
                responseFields(
                    ...
                    fieldWithPath("content[].discount").type(JsonFieldType.NUMBER)
                        .description("content[].discount"),
                    fieldWithPath("content[].gender").type(JsonFieldType.STRING)
                        .description("content[].gender"),
                    ...
                    fieldWithPath("content[].exposedTime").type(JsonFieldType.NUMBER)
                        .description("content[].exposedTime"),
                    fieldWithPath("content[].hairshopId").type(JsonFieldType.NUMBER)
                        .description("content[].hairshopId"),
